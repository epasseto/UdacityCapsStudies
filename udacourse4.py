...
def fn_get_top_article_id(df, 
                          ...
                          verbose=False):
    '''This function takes a dataframe of user vs articles interactions and
    return the titles of the most accessed ones. Old Version. For the Second
    part of the project (later, unifie this one with fn_get_top_article_id2)
    ...
    start = time()
    most_art = df.index.value_counts()[:max_art].index
...
def fn_get_top_article_id2(df,
    ...
    New Version, for the Third part of the project.
